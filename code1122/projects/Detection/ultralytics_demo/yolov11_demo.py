...
Create User : 19410
Desc : YOLOv11基于 ultralytics 的使用
"""
import os
...
def training():
    yaml_path = "./configs/yolo11s.yaml"
    model = YOLO(yaml_path)
    model.load("./configs/yolo11s.pt")  # 模型参数恢复(迁移的参数恢复)
...
# noinspection DuplicatedCode
def predicting():
    model_file = r".\configs\yolo11s.pt"
