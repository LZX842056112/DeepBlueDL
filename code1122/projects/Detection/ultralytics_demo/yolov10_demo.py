...
Create User : 19410
Desc : YOLOv10基于 ultralytics 的使用
"""
import os
...
def training():
    yaml_path = "./configs/yolov10s.yaml"
    model = YOLO(yaml_path)
    model.load("./configs/yolov10s.pt")  # 模型参数恢复(迁移的参数恢复)
...
# noinspection DuplicatedCode
def predicting():
    model_file = r".\configs\yolov10s.pt"
