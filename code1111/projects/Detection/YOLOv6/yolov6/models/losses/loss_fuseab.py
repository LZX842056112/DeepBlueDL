...
class ComputeLoss:
    '''Loss computation func. anchor base的损失计算'''
    ...
    def __call__(
        ...
        pred_distri[..., :2] += anchor_points_s  # 获取预测边框的cx cy w h; cx = 预测tx + grid cell中心点坐标
        pred_bboxes = xywh2xyxy(pred_distri) # xywh -> x1y1x2y2
