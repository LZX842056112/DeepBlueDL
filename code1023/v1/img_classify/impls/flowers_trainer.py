...
from ..optim_utils import build_optim_v2 as build_optim
from ..optim_utils import OptimArgs
...
class FlowersTrainer(Trainer):
    ...
    def build_summary_writer(self, summary_log_dir, net):
        ...
        # tensorboard --logdir D:\workspaces\study\CV202502\classify_17flowers\v1\output\logs
