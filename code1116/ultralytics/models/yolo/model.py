...
class YOLO(Model):
    ...
    def task_map(self) -> dict[str, dict[str, Any]]:
        ...
        return {
            ...
            "detect": {
                "model": DetectionModel,  # 目标检测的模型
                "trainer": yolo.detect.DetectionTrainer,  # 目标检测的训练器
                "validator": yolo.detect.DetectionValidator,  # 目标检测的验证评估器
                "predictor": yolo.detect.DetectionPredictor,  # 目标检测的预测器
            },
            "segment": {
